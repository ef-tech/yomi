...
export const ERROR_CODE_KEYS = {
  ...
  not_viewable: "error.not_viewable",
...
const MESSAGES = {
  ja: {
    ...
    "images.download.running": "画像を集めています…",
    "images.download.allSkipped":
      "入れられる画像がありませんでした（{skipped} 件の理由を SKIPPED.txt に入れました）",
    ...
    "error.not_viewable": "このファイルは表示できません",
    "error.file_too_large": "ファイルが大きすぎて表示できません",
    ...
    "error.zip_busy": "zip の作成が混み合っています。少し待ってからもう一度お試しください",
  ...
  en: {
    ...
    // Exclude settings panel (Issue #164)
    "yomiignore.open.aria": "Edit exclude settings (.yomiignore)",
    ...
    "images.download.running": "Collecting images…",
    "images.download.allSkipped":
      "No images could be included ({skipped} reason(s) in SKIPPED.txt)",
    ...
    "error.not_viewable": "This file cannot be displayed",
    "error.file_too_large": "The file is too large to display",
    ...
    "error.zip_busy": "The zip is busy. Please try again shortly",
